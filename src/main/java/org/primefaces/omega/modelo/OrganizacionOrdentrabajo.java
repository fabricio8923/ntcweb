...
/**
 * OrganizacionOrdentrabajo generated by hbm2java
 */
public class OrganizacionOrdentrabajo  implements java.io.Serializable {
    ...
    public OrganizacionOrdentrabajo() {
    }

	
    public OrganizacionOrdentrabajo(GeneralEstado generalEstado, OrganizacionOrganizacion organizacionOrganizacion, OrganizacionTrabajador organizacionTrabajador, PersonaPersona personaPersona, String codigo, String nombre, String descripcion, Date fechaInicio, Date fechaFin, int prioridadId, Date fechaCreacion, Date fechaModificacion, String usuarioModificacion, boolean estadoRegistro) {
    ...
    public OrganizacionOrdentrabajo(GeneralEstado generalEstado, OrganizacionOrganizacion organizacionOrganizacion, OrganizacionTrabajador organizacionTrabajador, PersonaPersona personaPersona, String codigo, String nombre, String descripcion, Date fechaInicio, Date fechaFin, int prioridadId, Date fechaCreacion, Date fechaModificacion, String usuarioModificacion, boolean estadoRegistro, Set organizacionDetordentrabajos) {
       this.generalEstado = generalEstado;
       this.organizacionOrganizacion = organizacionOrganizacion;
       this.organizacionTrabajador = organizacionTrabajador;
       this.personaPersona = personaPersona;
